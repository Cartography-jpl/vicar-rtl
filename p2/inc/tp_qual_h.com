...
$! VPACK Version 1.9, Wednesday, March 04, 1998, 09:58:30
$!
...
class TpQualifier {
  ...
  protected:
    ...
    friend ostream &operator<<(ostream &ostr, const TpQualifier &q);
...
class TpQualGroup {
  ...
  protected:
    ...
    friend ostream &operator<<(ostream &, const TpQualGroup &);
...
class TpQualGroupMgr {
  ...
  protected:
    ...
    friend ostream &operator<<(ostream &ostr, const TpQualGroupMgr &q);
