...
typedef struct
	...
	LblApiRealItem_typ		ArticulationDeviceTemp[2];
	LblApiNameItem_typ		ArticulationDeviceTempName[2];
	LblApiTypeItem_typ		ArticulationDeviceTempUnit[2];
...
int	LblArticulationApi( int, int, LblArticulation_typ *, int );
