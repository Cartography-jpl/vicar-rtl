...
$! VPACK Version 1.5, Thursday, November 12, 1992, 10:01:15
$!
...
void FTN_NAME(sumv)(dcode, n, avec, b, inca)
     int *dcode, *n, *inca;
     void *avec, *b;
{
   ...
   void *avec, *b;
{
  ...
  short int     *halfin,   halfout;
  long  int     *fullin,   fullout;
