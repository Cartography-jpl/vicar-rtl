...
$! VPACK Version 1.9, Tuesday, May 16, 2000, 15:44:37
$!
...
int FTN_NAME(txttext)(i, nl, ns, x, y, loc, n, a, flag1)
unsigned char *i;
short *nl, *ns, *x, *y, *loc, *n;
unsigned char *a;
int   *flag1;
...
/* int FTN_NAME(txtchr)(i, nl, ns, ichar, dx, dy, flag1) */
   /** no values returned -- TLT059 **/
void FTN_NAME(txtchr)(i, nl, ns, ichar, dx, dy, flag1)
unsigned char *i;
short *nl, *ns, *ichar, *dx, *dy;
int   *flag1;
{
...
int FTN_NAME(txvector)(i, nl, ns, v, x1, y1, x2, y2, flag)
unsigned char *i;
short *nl, *ns;
unsigned char *v;
short *x1, *y1, *x2, *y2;
...
int FTN_NAME(txvisible)(nl, ns, x1, y1, x2, y2)
int *nl, *ns, *x1, *y1, *x2, *y2;
{
