...
int  i,j,k,mc,nc,na;
{
   ...
   F77_FUNC(mmul32, MMUL32)
(&a, &i, &b, &j, &c, &k, &mc, &nc, &na);
   return;
...
void F77_FUNC (zfvup8, ZFVUP8)( zbuf, a, i, c, k, n)
int *zbuf;
int *a,*c;
int *i,*k,*n;
{
