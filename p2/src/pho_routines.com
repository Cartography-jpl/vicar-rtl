...
$! VPACK Version 1.8, Friday, March 15, 1996, 08:56:56
$!
...
int FTN_NAME(pho_free)( pho, status )
PHO_STRUCT **pho;
int	 *status;
{
...
int FTN_NAME(pho_get_func)( PHO_STRUCT **pho, char *func_name, int *fstat,
							ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
...
int FTN_NAME(pho_get_keys)( PHO_STRUCT **pho, char *fkeywds, int *num_kwd,
		int *fstat, ZFORSTR_PARAM)
{
  ...
  *fstat = phoGetKeys( *pho, pkeywds, num_kwd);
  ...
  zsc2for_array( keywds, len, *num_kwd, fkeywds, &max, &pho, 4, 2, 1, fstat);
  free(pkeywds);
...
int FTN_NAME(pho_get_mode)( PHO_STRUCT **pho, char *mode, int *fstat,
							ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
...
int FTN_NAME(pho_get_parms)( pho_obj, fstat )
 PHO *pho_obj;
 int *fstat;
...
int FTN_NAME(pho_get_val)( PHO_STRUCT **pho, char *fkey, double *val,
				int *fstat, ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
  char key[phoMAX_KEYWD_LENGTH+1];
...
int FTN_NAME(pho_init)( ptr, fstat )
int *ptr;
int *fstat;
...
int FTN_NAME(pho_set_func)( PHO_STRUCT **pho, char *func_name, int *fstat,
								ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
  char f_nam[phoMAX_FUNC_NAME_LENGTH+1];
...
int FTN_NAME(pho_set_mode)( PHO_STRUCT **pho, char *mode, int *fstat,
								ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
  char f_mode[phoMax_MODE_NAME_LENGTH+1];
...
int FTN_NAME(pho_set_val)( PHO_STRUCT **pho, char *fkey, double *val,
				int *fstat, ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
  char key[phoMAX_KEYWD_LENGTH+1];
...
int FTN_NAME(pho_correct)(pho_obj,MillMode,MSunShadow,MViewShadow,MilluArray,TillMode,TSunShadow,TViewShadow,TilluArray,phofuncval,fstat)
...
int FTN_NAME(pho_func)(pho_obj, illMode, SunShadow, ViewShadow, illuArray, phofuncval, fstat)
...
int FTN_NAME(pho_bidi_ref)(pho_obj,illMode,SunShadow,ViewShadow,illuArray,phofuncval,fstat)
...
FTN_NAME(xmosher)( arguments, params, result);
