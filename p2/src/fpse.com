...
$! VPACK Version 1.8, Friday, April 04, 1997, 15:28:25
$!
...
int  offs, n, type;
{
   ...
   FTN_NAME(apget)(buf, &offs, &n, &type);
   return;
...
int  offs, n, type;
{
   ...
   FTN_NAME(apput)(buf, &offs, &n, &type);
   return;
...
int  i,j,k,n1,n2;
{
   ...
   FTN_NAME(conv)(&a, &i, &b, &j, &c, &k, &n1, &n2);
   return;
...
int  i,j,k,n1,n2;
{
   ...
   FTN_NAME(hist)(&a, &i, &b, &j, &c, &k, &n1, &n2);
   return;
...
int  i,j,k,mc,nc,na;
{
   ...
   FTN_NAME(mmul32)(&a, &i, &b, &j, &c, &k, &mc, &nc, &na);
   return;
...
int  *i,*k,*n;
{
   ...
   FTN_NAME(vup8)( &a, &i, &c, &k, &n);
   return;

}


void FTN_NAME (zfvup8)( zbuf, a, i, c, k, n)
int *zbuf;
int *a,*c;
int *i,*k,*n;
{
int j, m, ibuf, II, JJ, ibuf2;
int A,I,C,K,N;
int *ptr;
float *fptr;
