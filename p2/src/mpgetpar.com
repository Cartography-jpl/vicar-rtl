...
$! VPACK Version 1.9, Sunday, July 23, 2000, 17:04:24
$!
...
int FTN_NAME(mp_get_par)(MP *mp, char *pdf_parameters,
...
while(  j < mpNUMBER_OF_KEYWORDS 
	&& pds_standard_keywords[j][0] != (char) NULL
	&& pds_standard_keywords[j][0] != '\\'
	&& pdf_parameters[j][0] != (char) NULL 
	&& pdf_parameters[j][0] != '\\' )
	{
	/*
