...
$! VPACK Version 1.9, Wednesday, April 08, 1998, 16:17:20
$!
...
void FTN_NAME(chk_year)(int *year, int *status)
{
...
void FTN_NAME(chk_range)(int *min, int *max, int *number, int *status)
{
...
void FTN_NAME (chk_month)(int *month, int *status)
{
...
/* verify leap year */ 
void FTN_NAME (chk_leap) (int *year, int *status)
{
...
void FTN_NAME (chk_day) (int *year, int *month, int *day, int *status)
{
...
void FTN_NAME (chk_hour) (int *hour, int *status)
{
...
void FTN_NAME (chk_minute) (int *minute, int *status)
{
...
void FTN_NAME (chk_second) (int *second, int *status)
{
...
void FTN_NAME (chk_msec) (int *msec, int *status)
{
...
void FTN_NAME (chk_julian) (int *year, int *julian, int *status)
{
...
void FTN_NAME (chk_scet_date) (int *date_buf, int *status)
{
...
void FTN_NAME (chk_std_date) (int *date_buf, int *status)
{
