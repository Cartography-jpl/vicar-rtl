...
$! VPACK Version 1.8, Friday, June 16, 1995, 15:38:09
$!
...
void FTN_NAME(istat_file_open)( int *unit, char *mode, int *nclasses,
...
void FTN_NAME(istat_signal)( unit,status,abendflag)
int *unit;
int *status;
int *abendflag;
{
...
void FTN_NAME(istat_file_close)( unit,status)
int *unit;
int *status;
{
...
void FTN_NAME(istat_file_info)(unit,nclasses,nbands,ibis) 
int *unit;
int *nclasses;
int *nbands;
int *ibis;
...
void FTN_NAME(istat_record_write)(int *unit, int *recnum, char *name,
...
void FTN_NAME(istat_record_read)(int *unit, int *recnum, char *name, int *npix,
...
int FTN_NAME(istat_record_find)(int *unit, char *classname, ZFORSTR_PARAM)
{
   ZFORSTR_BLOCK
   char c_name[33];
