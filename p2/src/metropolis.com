...
$! VPACK Version 1.8, Friday, July 14, 1995, 08:07:20
$!
...
void FTN_NAME(zzcost)(answer, array, array2, npts, retcost, ind)
...
costp = FTN_NAME(zzcost);
cost = costz;        /* The cost function to be called */
FTN_NAME(metropolis)(costp, &narg, array, array2, range, &nten, ans, 
