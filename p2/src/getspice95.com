...
$! VPACK Version 1.9, Monday, November 05, 2001, 10:55:16
$!
...

{
 ...
 FTN_NAME(irfrot) ( &refa, &refb, trotab );
 dptr = rotab;
 for(i = 0; i < 3; i++)
    for(j = 0; j < 3; j++) {
       *dptr = trotab[j][i];
 ...
 *========================================================*/
void FTN_NAME(getspice95) (int *mode, int *sc_id, char *camera, int *scet,
