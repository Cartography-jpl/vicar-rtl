...
$! VPACK Version 1.9, Tuesday, February 26, 2008, 14:58:27
$!
...
*/
void zprnt(int var1, int var2, int *stat, char *buf);
...
/*---------------------------------------------------------------------------*/
void FTN_NAME(getproj)(int *unit, char *project, int *camera, int *fds,
