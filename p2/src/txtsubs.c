...
void ztxvector(unsigned char *i, short nl, short ns, unsigned char v, short x1,
	      short y1, short x2, short y2, int *flag);
...
int F77_FUNC(txtcolor, TXTCOLOR)
(c)
short *c;
{
   return (ztxtcolor(*c));
...
int F77_FUNC(txtlength, TXTLENGTH)
(l, n, a)
short *l, *n;
unsigned char a[];
{
...
int F77_FUNC(txtrotate, TXTROTATE)
...
int F77_FUNC(txtsize, TXTSIZE)(h, s)
short *h;
float *s;
{
   return (ztxtsize(*h, *s));
...
int F77_FUNC(txttext, TXTTEXT)

(i, nl, ns, x, y, loc, n, a, flag1)
unsigned char *i;
short *nl, *ns, *x, *y, *loc, *n;
unsigned char *a;
int   *flag1;
...
/* int F77_FUNC_(txtchr, TXTCHR)(i, nl, ns, ichar, dx, dy, flag1) */
   /** no values returned -- TLT059 **/
void F77_FUNC(txtchr, TXTCHR)
(i, nl, ns, ichar, dx, dy, flag1)
unsigned char *i;
short *nl, *ns, *ichar, *dx, *dy;
int   *flag1;
{
...
void F77_FUNC(txvector, TXVECTOR)
(i, nl, ns, v, x1, y1, x2, y2, flag)
unsigned char *i;
short *nl, *ns;
unsigned char *v;
short *x1, *y1, *x2, *y2;
...
void ztxvector(i, nl, ns, v, x1, y1, x2, y2, flag)
unsigned char *i;
short nl, ns;
unsigned char v;
short x1, y1, x2, y2;
...
int F77_FUNC(txvisible, TXVISIBLE)
(nl, ns, x1, y1, x2, y2)
int *nl, *ns, *x1, *y1, *x2, *y2;
{
