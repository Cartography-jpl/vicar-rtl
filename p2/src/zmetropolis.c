...
void F77_FUNC(zzcost, ZZCOST)
(answer, array, array2, npts, retcost, ind)
...
costp = F77_FUNC(zzcost, ZZCOST);
cost = costz;        /* The cost function to be called */
F77_FUNC(metropolis, METROPOLIS)
(costp, &narg, array, array2, range, &nten, ans, 
