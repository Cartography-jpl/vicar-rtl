...
$! VPACK Version 1.9, Thursday, January 13, 2000, 13:39:50
$!
 ...
 ************************************************************************/
void	FTN_NAME(file_for_catalog)( char *file_spec_in, char *file_spec_out,
 ...
 *  an additional third parameter returning the status (0 - good, !0 - bad)
 ************************************************************************/
void	FTN_NAME(file_for_host)( char *file_spec_in, char *file_spec_out,
			int *status,ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
  char	Cstrg[256],
