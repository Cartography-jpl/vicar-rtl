...
$! VPACK Version 1.5, Thursday, November 05, 1992, 09:59:07
$!
...
{
FTN_NAME(histat)(ohist, &npts, mean, sigma, maxfreq);
}
...
{
FTN_NAME(histat2)(hist, &npts, mean, sigma,mindn,maxdn, maxfreq);
}
$ VOKAGLEVE
$ Return
$!#############################################################################
