...
$! VPACK Version 1.8, Monday, January 27, 1997, 15:23:24
$!
...
float *tiepoints;
{
FTN_NAME(iwrite_tiepoints)( &unit,&nah,&nav,&npts, tiepoints, &colcount);
}
...
float *tiepoints;
{
FTN_NAME(iread_tiepoints)( &unit,nah,nav,&maxpts, tiepoints, &colcount);
}
$ VOKAGLEVE
$ Return
$!#############################################################################
