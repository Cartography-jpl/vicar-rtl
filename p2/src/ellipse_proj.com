...
$! VPACK Version 1.9, Wednesday, October 09, 2002, 10:25:26
$!
...
oasx = oas;
scalex = scale;
FTN_NAME(ellipse_proj)(om,vsc,&flx,&oalx,&oasx,&scalex,&ra,&rb,&rc,
	v,rline,rsamp,&ind);
return(ind);
}
$ VOKAGLEVE
...
oasx = oas;
scalex = scale;
FTN_NAME(ellipse_inv)(om,vsc,&flx,&oalx,&oasx,&scalex,
...
FTN_NAME(ellipse_radius)(&lat,&lon,&ra,&rb,&rc,&lora,gcr);
return;
}
$ VOKAGLEVE
$!-----------------------------------------------------------------------------
...
{
FTN_NAME(azimuth) (om,op,vsc,vsun,&ra,&rb,&rc,&tc_flag,noraz,scaz,sunaz);
}
$ VOKAGLEVE
$ Return
$!#############################################################################
