...
float *tiepoints;
{
F77_FUNC_(iwrite_tiepoints, IWRITE_TIEPOINTS)
( &unit,&nah,&nav,&npts, tiepoints, &colcount);
}
...
float *tiepoints;
{
F77_FUNC_(iread_tiepoints, IREAD_TIEPOINTS)
( &unit,nah,nav,&maxpts, tiepoints, &colcount);
}
