...
int F77_FUNC_(pho_free, PHO_FREE)
( pho, status )
PHO_STRUCT **pho;
int	 *status;
{
...
int F77_FUNC_(pho_get_func, PHO_GET_FUNC)
( PHO_STRUCT **pho, char *func_name, int *fstat,
							ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
...
int F77_FUNC_(pho_get_keys, PHO_GET_KEYS)
( PHO_STRUCT **pho, char *fkeywds, int *num_kwd,
...
int F77_FUNC_(pho_get_mode, PHO_GET_MODE)
( PHO_STRUCT **pho, char *mode, int *fstat,
							ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
...
int F77_FUNC_(pho_get_parms, PHO_GET_PARMS)
( pho_obj, fstat )
 PHO *pho_obj;
 int *fstat;
...
int F77_FUNC_(pho_get_val, PHO_GET_VAL)
( PHO_STRUCT **pho, char *fkey, double *val,
				int *fstat, ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
  char key[phoMAX_KEYWD_LENGTH+1];
...
int F77_FUNC_(pho_init, PHO_INIT)
( ptr, fstat )
int *ptr;
int *fstat;
...
int F77_FUNC_(pho_set_func, PHO_SET_FUNC)
( PHO_STRUCT **pho, char *func_name, int *fstat,
								ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
...
int F77_FUNC_(pho_set_mode, PHO_SET_MODE)
( PHO_STRUCT **pho, char *mode, int *fstat,
								ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
...
int F77_FUNC_(pho_set_val, PHO_SET_VAL)
( PHO_STRUCT **pho, char *fkey, double *val,
				int *fstat, ZFORSTR_PARAM)
{
  ZFORSTR_BLOCK
...
int F77_FUNC_(pho_correct, PHO_CORRECT)
(pho_obj,MillMode,MSunShadow,MViewShadow,MilluArray,TillMode,TSunShadow,TViewShadow,TilluArray,phofuncval,fstat)
...
int F77_FUNC_(pho_func, PHO_FUNC)
(pho_obj, illMode, SunShadow, ViewShadow, illuArray, phofuncval, fstat)
...
int F77_FUNC_(pho_bidi_ref, PHO_BIDI_REF)
(pho_obj,illMode,SunShadow,ViewShadow,illuArray,phofuncval,fstat)
