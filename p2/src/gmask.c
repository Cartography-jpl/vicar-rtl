...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xacalculatehist, XACALCULATEHIST)
( int *Unit, int *SL, int *SS, int *EL,
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xacalculatePDShist, XACALCULATEPDSHIST)
( char *File, int *SL, int *SS,
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xaclearscale, XACLEARSCALE)
()
        {
	zaclearscale();
        }
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xacopymask, XACOPYMASK)
( unsigned char *ImFlag, ZFORSTR_PARAM)
        {
	ZFORSTR_BLOCK
        char *c_string;
        int length;
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xadefinescale, XADEFINESCALE)
(unsigned char *Scale_Type, int *Elength,
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xadeterminelimit, XADETERMINELIMIT)
(lowdn, highdn)
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xainitialize, XAINITIALIZE)
( UMaxLines, UMaxSamples, BG )
...
****************************************************************************/
        ...
        void F77_FUNC(xanamemaskfile, XANAMEMASKFILE)
(char *file, ZFORSTR_PARAM)
        {
	ZFORSTR_BLOCK
	char 	*c_string;
	int	length;
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xaoutsize, XAOUTSIZE)
( UMaxLines, UMaxSamples, BG )
  	int *UMaxLines, *UMaxSamples, *BG ;
        {
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xasetcharspacing, XASETCHARSPACING)
( Spacing )
 	int *Spacing;
         {
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xasetdim, XASETDIM)
( Dim)
 	int *Dim;
        {
 	zasetdim( *Dim);
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xasetfont, XASETFONT)
(char FontType[20], int *FontNum, ZFORSTR_PARAM)
        {
	ZFORSTR_BLOCK
        char c_string[20];
        int length;
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xasetfontangle, XASETFONTANGLE)
( Angle )
 	int *Angle ;
        {
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xastorebox, XASTOREBOX)
( StLine, StSample, Wid, Len, DnV )
...
/*         Fortran-Callable Version
/****************************************************************************/
	void F77_FUNC(xastorellipse, XASTORELLIPSE)
( CtLine, CtSample, R1, R2, Wid, DnV )
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xastorebuffer, XASTOREBUFFER)
(unsigned char Buf[],
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xastoregray, XASTOREGRAY)
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xastorehistogram, XASTOREHISTOGRAM)
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xastoreimage, XASTOREIMAGE)
( int *Unit, int *StLine, int *StSample,
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xastorePDSimage, XASTOREPDSIMAGE)
( char *File, int *StLine, int *StSample,
		int *EnLine, int *EnSample, int *OutStLine, int *OutStSample,
		unsigned char *StretBand, float *Frac, float *Satur,
                int ExClude[], int *Number_Of_Element, ZFORSTR_PARAM )
        {
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xastoreray, XASTORERAY)

(int *StLine, int *StSample, float *Ang,
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xastorestring, XASTORESTRING)( int *StLine, int *StSample, int *Sizval,
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xastoretick, XASTORETICK)
( StLine, StSample, EnLine, EnSample, Wid, 
                      Len, Space, DnV )
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xastorevector, XASTOREVECTOR)

( StLine, StSample, EnLine, EnSample, 
                                      Width, DnV )
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xastringlength, XASTRINGLENGTH)
( char ChString[MAXSTRINGSIZE],
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xazoomimage, xazoomimage)
(int *Unit, int *StLine, int *StSample,
		int *EnLine, int *EnSample, int *OutStLine, int *OutStSample,
...
/*         Fortran-Callable Version
/****************************************************************************/
 	void F77_FUNC(xascale, XASCALE)
( StartLine, StartSample, EnLine, EnSample, DnV )
