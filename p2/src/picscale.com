...
$! VPACK Version 1.9, Thursday, September 30, 1999, 18:07:50
$!
 ...
 *****************************************************************************/
void FTN_NAME (picscale)(sbuf,data,mp,mptype,sclat,sclon,nl,ns,pbuf,line,samp)
double *sbuf;
float  *data;
MP      mp; 
double *sclat,*sclon;
...
{
FTN_NAME(lighting) (buf,&lat,&lon,phase,incidence,emission) ;
}
$ VOKAGLEVE
$!-----------------------------------------------------------------------------
 ...
 *****************************************************************************/
void FTN_NAME (rpicscale)(sbuf,data,mp,mptype,sclat,sclon,r,nl,ns,pbuf,line,samp)
double *sbuf;
float  *data;
MP      mp; 
double *sclat,*sclon;
