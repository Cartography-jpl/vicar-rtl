...
void F77_FUNC_(chk_year, CHK_YEAR)
(int *year, int *status)
{
...
void F77_FUNC_(chk_range, CHK_RANGE)
(int *min, int *max, int *number, int *status)
{
...
void F77_FUNC_(chk_month, CHK_MONTH)
(int *month, int *status)
{
...
/* verify leap year */ 
void F77_FUNC_(chk_leap, CHK_LEAP) 
(int *year, int *status)
{
...
void F77_FUNC_(chk_day, CHK_DAY) 
...
void F77_FUNC_(chk_hour, CHK_HOUR) 
(int *hour, int *status)
{
...
void F77_FUNC_(chk_minute, CHK_MINUTE) 
(int *minute, int *status)
{
...
void F77_FUNC_(chk_second, CHK_SECOND) 
(int *second, int *status)
{
...
void F77_FUNC_(chk_msec, CHK_MSEC) 
(int *msec, int *status)
{
...
void F77_FUNC_(chk_julian, CHK_JULIAN) 
(int *year, int *julian, int *status)
{
...
void F77_FUNC_(chk_scet_date, CHK_SCET_DATE) 
(int *date_buf, int *status)
{
...
void F77_FUNC_(chk_std_date, CHK_STD_DATE) 
(int *date_buf, int *status)
{
