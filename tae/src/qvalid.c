 ...
 */
    ...
    FUNCTION CODE q_validintg(p, name, count, ilow, ihigh )
 ...
 */
    ...
    FUNCTION CODE q_validreal(p, name, count, rlow, rhigh )
 ...
 */
    ...
    FUNCTION CODE q_validstr(p, name, count, vector)
 ...
 */
    ...
    FUNCTION CODE q_validonestr(p, name, idx, onestr)
 ...
 */
    ...
    FUNCTION CODE q_validprep (p, name, count, type, vv)
