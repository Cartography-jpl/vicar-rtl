...
#ifdef UNIX
#define	GETLUN_TAE	F77_FUNC_(getlun_tae, GETLUN_TAE)
#define	SETLUN	F77_FUNC(setlun, SETLUN)
#define	GETSTD	F77_FUNC(getstd, GETSTD)
#define SETSTD	F77_FUNC(setstd, SETSTD)
#define OPNSTD	F77_FUNC(opnstd, OPNSTD)
#else			/* for VMS 	*/	
