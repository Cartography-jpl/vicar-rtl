...
extern BOOL Force_lower;
extern BOOL Pdf_lower;
...
FUNCTION COUNT s_equal(FAST TEXT *s, FAST TEXT *t);
...
FUNCTION COUNT pdf_lower(FAST TEXT* s);
...
FUNCTION BOOL f_pdf_lower
(
 BOOL	flag		/* TRUE for pdf_lower	*/
 );
...
/* terminal.np.c gets compiled twice for taetm, once in the library
   libtae and a second time with the flag TERMINAL_TOL defined. We
   want to make sure the symbols get pulled from the second compile.
   So if we aren't compiling using TERMINAL_TOL, declare these symbols
   to be "weak". That allows the symbols to be overridden.
*/
...
#pragma weak t_read
#pragma weak e_occur
#pragma weak t_1gettok
#pragma weak t_attn
#pragma weak t_bell
#pragma weak t_count
#pragma weak t_getpos
#pragma weak t_gettok
#pragma weak t_highlight
#pragma weak t_input
#pragma weak t_lclear
#pragma weak t_output
#pragma weak t_pinit
#pragma weak t_pos
#pragma weak t_signal
#endif
