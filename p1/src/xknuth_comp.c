...
void F77_FUNC_(knuth_complex, KNUTH_COMPLEX)
(char *string, complex_type *buf,int *status,
			ZFORSTR_PARAM)
#if 0
...
void F77_FUNC_(xknuth_complex, XKNUTH_COMPLEX)
(buf,result)
...
int zknuth_complex(char* string, complex_type* buf)
{
  int status=zknuth(string,(int*) buf);
