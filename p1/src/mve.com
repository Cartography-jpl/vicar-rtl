$!****************************************************************************
$!
$! Compile+link proc for MIPL program mve
$! VPACK Version 1.2, Wednesday, April 29, 1992, 16:51:07
$!
...
void zmve( dcode, n, a, b, inca, incb)
int dcode;			/* specifies numeric type of a and b	*/
int n;				/* number of values to move */
...
{
FTN_NAME(mve)( &dcode, &n, a, b, &inca, &incb);
}
$ Return
$!#############################################################################
$Imake_File:
