...
void F77_FUNC_(ibis_file_open, IBIS_FILE_OPEN)
( int *vunit, int *xunit_id, char *mode, int *ncol,
...
void F77_FUNC_(ibis_file_unit, IBIS_FILE_UNIT)
( int *vunit, int *xunit_id, char *mode, int *ncol,
	 int *nrow, char *format, char *org, int *status, ZFORSTR_PARAM )
#if 0
int *vunit;	/* input: VICAR file unit */
...
void F77_FUNC_(ibis_file_unit_open, IBIS_FILE_UNIT_OPEN)
( xunit_id, status )
int *xunit_id;	/* output - XIBIS file unit */
int *status;
{
...
void F77_FUNC_(ibis_file_close, IBIS_FILE_CLOSE)
( int *xunit_id, char *close_option,
...
int F77_FUNC_(ibis_file_get, IBIS_FILE_GET)
( int *ibis_id, char *name, void *value, int *sval,
...
void F77_FUNC_(ibis_file_set, IBIS_FILE_SET)
...
void F77_FUNC_(ibis_file_clear, IBIS_FILE_CLEAR)
( xunit_id, status)
