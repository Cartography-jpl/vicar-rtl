...
void F77_FUNC_(ibis_column_set, IBIS_COLUMN_SET)
(int *ibis_id, char *name, void *value,
	int *column, int *status, ZFORSTR_PARAM)
{
        ZFORSTR_BLOCK
...
void F77_FUNC_(ibis_column_read, IBIS_COLUMN_READ)
(int *ibis_id, char *buffer, int *column,
...
void F77_FUNC_(ibis_column_write, IBIS_COLUMN_WRITE)
(int *ibis_id, char *buffer,int *column,
			int *srow, int *nrows, int *status, ZFORSTR_PARAM )
{
   ZFORSTR_BLOCK
...
void F77_FUNC_(ibis_column_new, IBIS_COLUMN_NEW)
(int *ibis_id, int *column, int *ncols,
...
void F77_FUNC_(ibis_column_clear, IBIS_COLUMN_CLEAR)
(ibis_id,column,ncols,status)
int *ibis_id;
int *column;
int *ncols;
int *status;
...
void F77_FUNC_(ibis_column_delete, IBIS_COLUMN_DELETE)
(ibis_id,column,ncols,status)
int *ibis_id;
int *column;
int *ncols;
...
void F77_FUNC_(ibis_column_move, IBIS_COLUMN_MOVE)
(ibis_id,sourcecol,destcol,ncols,status)
int *ibis_id;
int *sourcecol;
int *destcol;
int *ncols;
...
int F77_FUNC_(ibis_column_find, IBIS_COLUMN_FIND)
( int *ibis_id, char *type, char *group,
