...
$! VPACK Version 1.9, Monday, March 16, 1998, 14:45:37
$!
...
void ICLGetPrimitive(ibis,group,expression)
int ibis;
char *group;
char *expression;
{
...
void ICLGetROOT(ibis,group,inst)
int ibis;
...
void ICLGetPOSITION(ibis,group,inst)
int ibis;
char *group;  /* name of group */
char *inst;
{
...
void ICLGetPOS_IMAGE(ibis,gline,gsamp,gband,inst)
int ibis;
char *gline;
char *gsamp;
char *gband;
...
void ICLGetPOS_GEOGRAPHIC(ibis,glat,glong,inst)
int ibis;
char *glat;
char *glong;
char *inst;
...
void ICLGetVALUE(ibis,group,inst)
int ibis;
char *group;
char *inst;
{
...
void ICLGetRGB(ibis,gred,ggreen,gblue,inst)
int ibis;
char *gred;
char *ggreen;
char *gblue;
...
void ICLGetPIXEL(ibis,gpos,gval,inst)
int ibis;
char *gpos;
char *gval;
char *inst;
...
void ICLGetDIRECTION(ibis,group,inst)
int ibis;
char *group;
char *inst;
{
...
void ICLGetMATRIX(ibis,gmat,gind,inst)
int ibis;
char *gmat;
char *gind;
char *inst;
...
void ICLGetQUALITY(ibis,gqual,inst)
int ibis;
char *gqual;
char *inst;
{
...
void ICLGetHISTOGRAM(ibis,gmat,gind,inst)
int ibis;
char *gmat;
char *gind;
char *inst;
...
void ICLGetLOOKUP_TABLE(ibis,gps,gind,memname,inst)
int ibis;
char *gps;
char *gind;
char *memname;
...
void ICLGetSTATISTICS(ibis,gmat,gind,memname,inst)
int ibis;
char *gmat;
char *gind;
char *memname;
...
void ICLGetPOINT(ibis,gpos,gval,memname,inst)
int ibis;
char *gpos;
char *gval;
char *memname;
...
void FTN_NAME(icl_get_root)(int *ibis,char *group,char *inst, ZFORSTR_PARAM)
#if 0
char *group;  /* name of group */
#endif
{
...
void FTN_NAME(icl_get_position)(int *ibis, char *group,char *inst,ZFORSTR_PARAM)
#if 0
char *group;  /* name of group */
#endif
{
...
void FTN_NAME(icl_get_pos_image)(int *ibis, char *gline, char *gsamp,
	char *gband, char *inst, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_get_pos_geographic)(int *ibis, char *glat, char *glong,
...
void FTN_NAME(icl_get_value)(int *ibis, char *group, char *inst, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
	char group_c[MAX_GRP_SIZE+1],*grp=(char *)0;
...
void FTN_NAME(icl_get_rgb)(int *ibis, char *gred, char *ggreen, char *gblue,
		char *inst, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_get_pixel)(int *ibis, char *gpos, char *gval, char *inst,
			ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_get_direction)(int *ibis, char *group, char *inst,
		ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_get_matrix)(int *ibis, char *gmat, char *gind, char *inst,
			ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_get_quality)(int *ibis, char *group, char *inst,ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
	char group_c[MAX_GRP_SIZE+1],*grp=(char *)0;
...
void FTN_NAME(icl_get_histogram)(int *ibis, char *gmat, char *gind, char *inst,
			ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_get_lookup_table)(int *ibis, char *gps, char *gind,
		char *memname, char *inst, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
	char ggrp1_c[MAX_GRP_SIZE+1],*gg1=(char *)0;
...
void FTN_NAME(icl_get_statistics)(int *ibis, char *gmat, char *gind,
		char *memname, char *inst, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_get_point)(int *ibis, char *gpos, char *gval, char *memname,
		char *inst, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_new_root)(int *ibis, int *cols, int *ncols, char *inst,
...
void FTN_NAME(icl_new_position)(int *ibis, int *cols, int *ncols, char *inst,
		int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_new_pos_image)(int *ibis, int *line, int *samp, int *band,
...
void FTN_NAME(icl_new_pos_geographic)(int *ibis, int *lat, int *longv,
		char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_new_value)(int *ibis, int *cols, int *ncols, char *inst,
		int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_new_rgb)(int *ibis, int *red, int *green, int *blue,
		char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_new_pixel)(int *ibis, int *pos, int *npos, int *val,
		int *nval, char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_new_direction)(int *ibis, int *cols, int *ncols, char *inst,
		int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_new_matrix)(int *ibis, int *mat, int *nmat, int *ind,
		int *nind, char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_new_quality)(int *ibis, int *qual, int *nqual, char *inst,
		int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_new_histogram)(int *ibis, int *mat, int *nmat, int *ind,
		int *nind, char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void FTN_NAME(icl_new_lookup_table)(int *ibis, int *ps, int *nps, int *ind, int *nind, char *memname, char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
	char group_c[MAX_GRP_SIZE+1],*grp=(char *)0;
...
void FTN_NAME(icl_new_statistics)(int *ibis, int *mat, int *nmat, int *ind,
	int *nind, char *memname, char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
	char group_c[MAX_GRP_SIZE+1],*grp=(char *)0;
...
void FTN_NAME(icl_new_point)(int *ibis, int *pos, int *npos, int *val,
	int *nval, char *memname, char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
	char group_c[MAX_GRP_SIZE+1],*grp=(char *)0;
