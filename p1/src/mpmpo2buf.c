 ...
 */
  ...
  if (EQUAL( maptype, mpPOINT_PERSPECTIVE)) {	/* PERSPECTIVE is special */
    ...
    {
      double float_buf1[3][3], float_buf2[3];
      float_buf1[0][0] = float_buf[0];
      float_buf1[0][1] = float_buf[1];
      float_buf1[0][2] = float_buf[2];
      float_buf1[1][0] = float_buf[3];
      float_buf1[1][1] = float_buf[4];
      float_buf1[1][2] = float_buf[5];
      float_buf1[2][0] = float_buf[6];
      float_buf1[2][1] = float_buf[7];
      float_buf1[2][2] = float_buf[8];
      float_buf2[0] = float_buf[18];
      float_buf2[1] = float_buf[19];
      float_buf2[2] = float_buf[20];
      momati_c( mom[0], mom[1], mom[2], mom[3], mom[4], mom[5], mom[6],
		mom[7], mom[8], mom[9], float_buf1, float_buf2);
