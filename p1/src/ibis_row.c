...
void F77_FUNC_(ibis_row_clear, IBIS_ROW_CLEAR)
(ibis_id, row, nrows, status)
int *ibis_id;
int *row;
int *nrows;
int *status;
...
void F77_FUNC_(ibis_row_new, IBIS_ROW_NEW)
(ibis_id, row, nrows, status)
int *ibis_id;
int *row;
int *nrows;
...
void F77_FUNC_(ibis_row_delete, IBIS_ROW_DELETE)
(ibis_id, row, nrows, status)
int *ibis_id;
int *row;
int *nrows;
