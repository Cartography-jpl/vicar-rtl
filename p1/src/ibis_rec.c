...
void F77_FUNC_(ibis_record_open, IBIS_RECORD_OPEN)
( int *ibis_id, int *record_id, char *group,
...
void F77_FUNC_(ibis_record_close, IBIS_RECORD_CLOSE)
( record_id, status)
int *record_id;
int *status;
{
...
void F77_FUNC_(ibis_record_set, IBIS_RECORD_SET)
( int *record_id, char *name, void *value,
...
int F77_FUNC_(ibis_record_get, IBIS_RECORD_GET)
( int *record_id, char *name, char *value,
...
void F77_FUNC_(ibis_record_read, IBIS_RECORD_READ)
(int *record_id, char *buffer, int *row,
		int *status, ZFORSTR_PARAM)
{
   ZFORSTR_BLOCK
   XREC *record=IBIS_FETCH_REC_ID(*record_id);
...
void F77_FUNC_(ibis_record_write, IBIS_RECORD_WRITE)
(int *record_id, char *buffer, int *row,
		int *status, ZFORSTR_PARAM)
{
   ZFORSTR_BLOCK
...
void F77_FUNC_(ibis_record_clear, IBIS_RECORD_CLEAR)
(record_id, row, nrows, status)
int *record_id;
int *row;
int *nrows;
int *status;
