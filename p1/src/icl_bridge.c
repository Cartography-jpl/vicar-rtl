...
void F77_FUNC_(icl_get_root, ICL_GET_ROOT)
(int *ibis,char *group,char *inst, ZFORSTR_PARAM)
#if 0
...
void F77_FUNC_(icl_get_position, ICL_GET_POSITION)
(int *ibis, char *group,char *inst,ZFORSTR_PARAM)
#if 0
char *group;  /* name of group */
#endif
...
void F77_FUNC_(icl_get_pos_image, ICL_GET_POS_IMAGE)
(int *ibis, char *gline, char *gsamp,
...
void F77_FUNC_(icl_get_pos_geographic, ICL_GET_POS_GEOGRAPHIC)
(int *ibis, char *glat, char *glong,
...
void F77_FUNC_(icl_get_value, ICL_GET_VALUE)
(int *ibis, char *group, char *inst, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_get_rgb, ICL_GET_RGB)
(int *ibis, char *gred, char *ggreen, char *gblue,
		char *inst, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_get_pixel, ICL_GET_PIXEL)
(int *ibis, char *gpos, char *gval, char *inst,
			ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_get_direction, ICL_GET_DIRECTION)
(int *ibis, char *group, char *inst,
		ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_get_matrix, ICL_GET_MATRIX)
(int *ibis, char *gmat, char *gind, char *inst,
			ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_get_quality, ICL_GET_QUALITY)
(int *ibis, char *group, char *inst,ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_get_histogram, ICL_GET_HISTOGRAM)
(int *ibis, char *gmat, char *gind, char *inst,
			ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
...
void F77_FUNC_(icl_get_lookup_table, ICL_GET_LOOKUP_TABLE)
(int *ibis, char *gps, char *gind,
...
void F77_FUNC_(icl_get_statistics, ICL_GET_STATISTICS)
(int *ibis, char *gmat, char *gind,
		char *memname, char *inst, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_get_point, ICL_GET_POINT)
(int *ibis, char *gpos, char *gval, char *memname,
		char *inst, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_new_root, ICL_NEW_ROOT)
(int *ibis, int *cols, int *ncols, char *inst,
...
void F77_FUNC_(icl_new_position, ICL_NEW_POSITION)
(int *ibis, int *cols, int *ncols, char *inst,
		int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
...
void F77_FUNC_(icl_new_pos_image, ICL_NEW_POS_IMAGE)
(int *ibis, int *line, int *samp, int *band,
...
void F77_FUNC_(icl_new_pos_geographic, ICL_NEW_POS_GEOGRAPHIC)
(int *ibis, int *lat, int *longv,
		char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_new_value, ICL_NEW_VALUE)
(int *ibis, int *cols, int *ncols, char *inst,
		int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
...
void F77_FUNC_(icl_new_rgb, ICL_NEW_RGB)
(int *ibis, int *red, int *green, int *blue,
		char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_new_pixel, ICL_NEW_PIXEL)
(int *ibis, int *pos, int *npos, int *val,
...
void F77_FUNC_(icl_new_direction, ICL_NEW_DIRECTION)
(int *ibis, int *cols, int *ncols, char *inst,
		int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
...
void F77_FUNC_(icl_new_matrix, ICL_NEW_MATRIX)
(int *ibis, int *mat, int *nmat, int *ind,
...
void F77_FUNC_(icl_new_quality, ICL_NEW_QUALITY)
(int *ibis, int *qual, int *nqual, char *inst,
		int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
...
void F77_FUNC_(icl_new_histogram, ICL_NEW_HISTOGRAM)
(int *ibis, int *mat, int *nmat, int *ind,
		int *nind, char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
...
void F77_FUNC_(icl_new_lookup_table, ICL_NEW_LOOKUP_TABLE)
(int *ibis, int *ps, int *nps, int *ind, int *nind, char *memname, char *inst, int *status, ZFORSTR_PARAM)
{
	ZFORSTR_BLOCK
	char inst_c[MAX_GRP_SIZE+1],*in=(char *)0;
	char group_c[MAX_GRP_SIZE+1],*grp=(char *)0;
...
void F77_FUNC_(icl_new_statistics, ICL_NEW_STATISTICS)
(int *ibis, int *mat, int *nmat, int *ind,
...
void F77_FUNC_(icl_new_point, ICL_NEW_POINT)
(int *ibis, int *pos, int *npos, int *val,
