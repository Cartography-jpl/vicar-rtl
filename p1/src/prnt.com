...
$! VPACK Version 1.5, Wednesday, March 24, 1993, 13:47:52
$!
...
void FTN_NAME(prnt)(int *dcode, int *n, void *buf, char *title, ZFORSTR_PARAM)
#if 0
...
void *buf;        /* array of data elements to be printed*/
{
 static char stars10[]= " **********";
 char        fmt[10];
 int i, ns, nchars, nc, maxcount, ndright;
 unsigned char *bbuf;
 char 	       *cbuf;
 short         *hbuf;
 int           *ibuf;
...
prnt_catchar(a)     
			/*  pbuf declared externally  */
unsigned char *a;    /* character to be added to pbuf */
{
   unsigned char c;
/*  ==================================================================  */
   c = *a;
