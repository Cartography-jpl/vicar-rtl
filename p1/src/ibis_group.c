...
int F77_FUNC_(ibis_group_new, IBIS_GROUP_NEW)

(int *ibis_id, char *type, char *name, int *cols,
...
void F77_FUNC_(ibis_group_delete, IBIS_GROUP_DELETE)( int *ibis_id, char *type, char *name,
...
void F77_FUNC_(ibis_group_modify, IBIS_GROUP_MODIFY)
( int *ibis_id, char *type, char *name, char *mod, int *cols, int *ncols, int *status, ZFORSTR_PARAM )
#if 0
char *type;		/* "group", or "unit", etc */
#endif
{
...
int F77_FUNC_(ibis_group_find, IBIS_GROUP_FIND)
( int *ibis_id, char *type, int *column,
...
int F77_FUNC_(ibis_group_transfer, IBIS_GROUP_TRANSFER)
( int *in_id, int *out_id, char *type, int *incols, int *outcols, int *nc, ZFORSTR_PARAM )
#if 0
char *type;		/* "group", or "unit", etc */
#endif
{
