...
void F77_FUNC(xvhost, XVHOST)
(char *host, char *intfmt, char *realfmt, int *status,
							ZFORSTR_PARAM)
...
char *intfmt, *realfmt;		/* Out: Int and real data representations */
{
   ...
   make_upper_case_max(c_host, host, 29);
   ...
   strcpy(intfmt, "");
   strcpy(realfmt, "");
   error_handler(NO_UNIT, INVALID_HOST);	/* Host not found */
   return INVALID_HOST;
}
