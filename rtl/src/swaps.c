...
int trans_swap2(void *fromi, void* toi, int len, struct trans *UNUSED(trans))
{
...
int trans_swap4(void *fromi, void* toi, int len, struct trans *UNUSED(trans))
{
   int *from = (int *) fromi;
   int *to = (int *) toi;
   register int i;
...
int trans_swap8(void *fromi, void* toi, int len, struct trans *UNUSED(trans))
{
