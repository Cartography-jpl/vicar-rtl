...
unsigned char *ieee;
{
   ...
   double_byte_swap(from, vaxf);	/* Put bytes in rational order */
...
unsigned char *to;
{
   ...
   double_byte_swap(vaxf, to);	/* Put bytes in weird VAX order */
