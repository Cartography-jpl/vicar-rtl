...
int i_search_name(char* tape[], int count, char *name)
{
...
int i_search_device (char* tape[], int count, char *device) 
{
   char e_name[TAPENAMESIZE+1], e_device[TAPEDEVSIZE+1];
   int i;
...
int i_analyze (char *filespec, char *tape_table[], int count, int *index, 
	       int *filenr)
{
