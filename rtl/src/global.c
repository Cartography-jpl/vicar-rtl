...
{   NULL,          NO,  INTEGER,  4,   1,  SYSTEM, O|      G,  "EOCI1"}, /*end of compressed data
                                                                        from start of file - lower
                                                                        end of 64 bit*/
{   NULL,          NO,  INTEGER,  4,   1,  SYSTEM, O|      G,  "EOCI2"}  /*end of compressed data
                                                                        from start of file - upper
                                                                        end of 64 bit*/
};
...
/* value is correct if it is equal to "NULL" or "BASIC" */
