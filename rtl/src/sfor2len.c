...
int sfor2len(for_string, argptr, nargs, argno, strno)
...
int v2_sfor2len(char * UNUSED(for_string), void *argptr, int nargs, 
		int UNUSED(argno), int strno, va_list* valist, int *which)
