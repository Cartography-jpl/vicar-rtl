...
#if VAX_ARCH+ALPHA_ARCH+SUN3_ARCH+SUN4_ARCH+SUN_SOLARIS_ARCH+X86_SOLARIS_ARCH+ALLIANT_ARCH+DECSTATION_ARCH+CRAY_ARCH+MAC_AUX_ARCH+MAC_MPW_ARCH+SGI_ARCH+TEK_ARCH+HP700_ARCH+AXP_UNIX_ARCH+AXP_LINUX_ARCH+X86_LINUX_ARCH+PPC_LINUX_ARCH+MAC_OSX_ARCH+X86_NT_ARCH != 1
Compile Error: *_ARCH either not defined or not defined correctly!!!!!!!!!!!
#endif

/* Shortcut for Linuxes */
#if AXP_LINUX_ARCH + X86_LINUX_ARCH + PPC_LINUX_ARCH
...
#if MAC_OSX_ARCH
/* Have two kinds of macs, the older power pc and the newer intel
   based macs. Pick between the two machines, since the int and real
   formats differ. */
#if defined(__ppc__)
...
#if MAC_AUX_ARCH + MAC_MPW_ARCH + HP700_ARCH + AXP_UNIX_ARCH + MAC_OSX_ARCH + X86_NT_ARCH
#define NARGS_AVAIL_OS 0
#endif
...
#if SUN3_ARCH + SUN4_ARCH + SUN_SOLARIS_ARCH + X86_SOLARIS_ARCH + DECSTATION_ARCH + ALLIANT_ARCH + MAC_AUX_ARCH + AXP_UNIX_ARCH + ANY_LINUX_ARCH + MAC_OSX_ARCH
...
#if SGI_ARCH + TEK_ARCH + HP700_ARCH + AXP_UNIX_ARCH + ANY_LINUX_ARCH + MAC_OSX_ARCH + X86_NT_ARCH
#define FSTAT_AVAIL_OS 1
#endif
...
#if HP700_ARCH + AXP_UNIX_ARCH + ANY_LINUX_ARCH + MAC_OSX_ARCH
#define MMAP_AVAIL_OS	1
#endif
...
#if SUN_SOLARIS_ARCH + X86_SOLARIS_ARCH + DECSTATION_ARCH + ALLIANT_ARCH + MAC_AUX_ARCH + SGI_ARCH + TEK_ARCH + MAC_OSX_ARCH
...
#if SUN3_ARCH + SUN4_ARCH + SUN_SOLARIS_ARCH + X86_SOLARIS_ARCH + DECSTATION_ARCH + SGI_ARCH + TEK_ARCH + HP700_ARCH + AXP_UNIX_ARCH + ANY_LINUX_ARCH + MAC_OSX_ARCH
...
#if SUN3_ARCH + SUN4_ARCH + SUN_SOLARIS_ARCH + X86_SOLARIS_ARCH + ALLIANT_ARCH + DECSTATION_ARCH + SGI_ARCH + TEK_ARCH + ANY_LINUX_ARCH + MAC_OSX_ARCH
#define OPEN_PROTECT_OS	1
#endif
...
#if SUN3_ARCH + SUN4_ARCH + SUN_SOLARIS_ARCH + X86_SOLARIS_ARCH + MAC_AUX_ARCH + DECSTATION_ARCH + SGI_ARCH + ANY_LINUX_ARCH + MAC_OSX_ARCH
...
#if MAC_MPW_ARCH + ANY_LINUX_ARCH + MAC_OSX_ARCH + X86_NT_ARCH
...
#if SUN3_ARCH + SUN4_ARCH + SGI_ARCH + MAC_AUX_ARCH + AXP_UNIX_ARCH + ANY_LINUX_ARCH + MAC_OSX_ARCH
#define GETDTABLESIZE_OS 1
#endif
...
#if AXP_UNIX_ARCH + AXP_LINUX_ARCH + MAC_OSX_ARCH
