...
struct trans {
   int (*transfn)(void *from, void *to, int len, struct trans *trans);
				/* composite translation function */
   int (*transfn1)(void *from, void *to, int len, struct trans *trans);		
				/* step 1 of translation */
   int (*transfn2)(void *from, void *to, int len, struct trans *trans);		
