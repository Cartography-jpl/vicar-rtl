 ...
 */
    FUNCTION CODE getprim(sb, value)
 ...
 * routine, execute it.
 */
    FUNCTION static struct STATE *getstate(curstate, class, token, locval)
 ...
 */
    FUNCTION static CODE packval(locval, value)
 ...
 */
    FUNCTION CODE asciiact(token, locval)
 ...
 */
    FUNCTION CODE concact(token, locval)
 ...
 *
 */
    FUNCTION CODE expact(token, locval)
 ...
 *
 */
    FUNCTION CODE fract(token, locval)
 ...
 */
    FUNCTION CODE gequact(token, locval)
 ...
 */
    FUNCTION CODE gtract(token, locval)
 ...
 *
 */
    FUNCTION CODE intact(token, locval)
 ...
 */
    FUNCTION CODE lessact(token, locval)
 ...
 */
    FUNCTION CODE nameact(token, locval)
 ...
 */
    FUNCTION CODE negexact(token, locval)
 ...
 */
    FUNCTION CODE lequact(token, locval)
 ...
 */
    FUNCTION CODE nequact(token, locval)
 ...
 */
    FUNCTION CODE nullact(token, locval)
 ...
 */
    FUNCTION CODE putbact(token, locval)
 ...
 */
    FUNCTION CODE quact(token, locval)
