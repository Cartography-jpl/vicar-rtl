 ...
 */
    ...
    UNSUPPORTED struct VARIABLE *Vm_Alloc(symtab, name, type, count, strsiz)
 ...
 */
    ...
    UNSUPPORTED TEXT *Vm_Save (string)
 ...
 */
    ...
    UNSUPPORTED char *Vm_AllocValue(v)
 ...
 */
    ...
    UNSUPPORTED struct VARIABLE *Vm_AllocVar(head)
 ...
 */
    ...
    UNSUPPORTED VOID Vm_FreeValue(pv, type, count)
 ...
 */
    ...
    UNSUPPORTED COUNT Vm_ValueSize(type)
