...
c      data P / -.11111111111111111111d+00,  .22540333075851662296d+00,
c     *         .55555555555555555556d+00,  .647209421402969791d-02,
c     *        -.928968790944433705d-02,    .39508731291979716579d-01,
c     *         .10465622602646726519d+00,  .56575625065319744200d+00,
c     *         .40139741477596222291d+00,  .5223046896961622d-04,
c     *         .17121030961750000d-03,    -.724830016153892898d-03,
c     *        -.7017801099209042d-04,      .61680367872449777899d-02,
c     *         .17001719629940260339d-01,  .11154076712774300110d+00,
c     *         .92927195315124537686d-01,  .37889705326277359705d+00,
c     *         .17151190913639138079d+00,  .77661331357103311837d+00,
c     *         .21915685840158749640d+00,  .682166534792d-08,
c     *         .12667409859336d-06,        .59565976367837165d-05,
c     *         .1392330106826d-07,        -.6629407564902392d-04,
c     *        -.704395804282302d-06,      -.34518205339241d-07,
c     *        -.814486910996d-08,          .90187503233240234038d-03,
c     *         .25447807915618744154d-02,  .18468850446259893130d-01,
c     *         .16446049854387810934d-01,  .70345142570259943330d-01,
c     *         .35957103307129322097d-01,  .16327406183113126449d+00,
c     *         .56979509494123357412d-01,  .29750379350847292139d+00,
c     *         .76879620499003531043d-01,  .46868025635562437602d+00,
c     *         .93627109981264473617d-01,  .66886460674202316691d+00,
c     *         .10566989358023480974d+00,  .88751105686681337425d+00,
c     *         .11195687302095345688d+00,  .371583d-15,
c     *         .21237877d-12,              .10522629388435d-08,
c     *         .1748029d-14,               .3475718983017160d-06,
c     *         .90312761725d-11,           .12558916d-13,
c     *         .54591d-15,                -.72338395508691963d-05,
c     *        -.169699579757977d-07,      -.854363907155d-10,
c     *        -.12281300930d-11,          -.462334825d-13,
c     *        -.42244055d-14,             -.88501d-15,
c     *        -.40904d-15,                 .12711187964238806027d-03,
c     *         .36322148184553065969d-03,  .27937406277780409196d-02,
c     *         .25790497946856882724d-02,  .11315242452570520059d-01,
c     *         .61155068221172463397d-02,  .27817125251418203419d-01,
c     *         .10498246909621321898d-01,  .53657141626597094849d-01,
c     *         .15406750466559497802d-01,  .89628843042995707499d-01,
c     *         .20594233915912711149d-01,  .13609206180630952284d+00,
c     *         .25869679327214746911d-01,  .19305946804978238813d+00,
c     *         .31073551111687964880d-01,  .26024395564730524132d+00,
c     *         .36064432780782572640d-01,  .33709033997521940454d+00,
c     *         .40715510116944318934d-01,  .42280428994795418516d+00,
c     *         .44914531653632197414d-01,  .51638197305415897244d+00,
c     *         .48564330406673198716d-01,  .61664067580126965307d+00,
c     *         .51583253952048458777d-01,  .72225017797817568492d+00,
c     *         .53905499335266063927d-01,  .83176474844779253501d+00,
c     *         .55481404356559363988d-01,  .94365568695340721002d+00,
c     *         .56277699831254301273d-01,  .1041098d-15,
c     *         .249472054598d-10,          .55d-20,
c     *         .290412475995385d-07,       .367282126d-13,
c     *         .5568d-18,                 -.871176477376972025d-06,
c     *        -.8147324267441d-09,        -.8830920337d-12,
c     *        -.18018239d-14,             -.70528d-17,
c     *         .14055382072649964277d-01,  .95773083523463639678d+00,
c     *         .14080351962553661325d-01,  .98590611358921753738d+00,
c     *         .14092845069160408355d-01 /
c++ END
C
...
630   CONTINUE
      IF(IEND)THEN
      IF (NSUB.EQ.0) GO TO 20067
      IF(ABS(ALOCAL-TA).GE.0.125d0*ABS(TB))THEN
      IF (.NOT.DID1.OR.XJP.LE.0.1d0) GO TO 20067
               ISTOP(2,1)=18
...
C
670   CONTINUE
      IF(XJ.GT.0.0d0.AND.NSUB.LT.NSUBMX.AND.(INIT.OR.LENDT-IC2.GE.2))THE
     *N
...
C           SET A CAUTION POINT.
      ...
      END IF
C $         COL1(SHORTA,1,1)
            BLOCAL=0.5d0*(ALOCAL+BLOCAL)
c           BLOCAL=ALOCAL+0.5d0*(BLOCAL-ALOCAL)
            DELTA=0.5d0*DELTA
      END IF
         IEND=.FALSE.
         DELMIN=DINTSM(ALOCAL)
...
920      I=6-NSUB/2
         ...
         IF (NSUB.EQ.0)                                                 
     *      DELTA=MIN(DELTA,ABS(XT(6)-ALOCAL)+2.0d0*ABS(XT(6)-XT(5)))
         DELTA=Z(1)*DELTA
...
C
      ...
      IF (ABS(X2-X1).LE.8.0d0*ABS(X1-BLOCAL)) GO TO 20148
      END IF
      IF (PART.EQ.2) GO TO 20150
      IF (.NOT.IEND) GO TO 20150
                  X1=X2
      END IF
      END IF
            DELTA=ABS(X1-ALOCAL)
...
C
      IF(PART.NE.1)THEN
            I=2
c##         EPSR=EPSR+ERRT(2)
      IF (STEP(1)*STEP(2).LE.0.0d0) GO TO 20157
      END IF
         END(2)=ALOCAL
         I=1
20157 TLEN=ABS(END(2)-END(1))
      FSAVE=FATA
      FSAVED=FATAS
      S=START(1)
      START(1)=X1
...
20172    ABSCIS=XT(J)+0.25d0*(XT(I)-XT(J))
         GO TO 1490
1410     CONTINUE
...
C        END IF
      END IF
20187 IF(ABSCIS.EQ.XT(I).OR.ABSCIS.EQ.XT(J))THEN
C $      COL1(SHORTA,1,1)
C        X1=0.5d0*(XT(I)+XT(J))
...
C              THERE IS A JUMP AT THE OTHER END OF THE PANEL.
               KMAX=KAIMT+1
20229       IF (ENDPTS-2) 2750,2760,2235
      END IF
C
...
2060     CONTINUE
      ...
      IF(RE.LT.1.0d0)THEN
      IF (NSUB.NE.0.AND.                                                
     *ABS((LOCAL(3)-TA)/(LOCAL(4)-LOCAL(3)))                            
     *.LE.1.0d0) GO TO 20234
      ELSEIF(ERRI.LT.100.0d0*EPSMIN)THEN
      IF (4.0d0*ERR.GT.EPSMIN) GO TO 20236
                  IF (.NOT.INIT.AND.DISCHK.LE.0) GO TO 2250
                  IF (ENDPTS-2) 2750,2760,2250
      END IF
      IF (REPROD.GE.1.0D-4) GO TO 20234
      IF (K.LT.KAIMT.AND.ERR.GT.100.0d0*EPSMIN) GO TO 20234
      IF (ERRI*REPROD.GT.0.01d0*EPNOIZ) GO TO 20234
      IF (RE*ERR.LT.EPS) GO TO 20234
20236       IF (ENDPTS-2) 2750,2760,2120
...
2350  FATA=FATB
      ...
      END IF
      IF(NSUB.NE.0)THEN
      IF(ABS(BLOCAL-START(PART)).LT.ABS(TEND-START(PART))-DELMIN)THEN
      IF (.NOT.HAVDIF) GO TO 20270
      IF (PHISUM.LT.FLOAT(10*(K-KAIMT))*PHTSUM) GO TO 20272
      IF (PHISUM.GE.16.0d0*PHTSUM) GO TO 20270
      IF (PHISUM.GE.PHTSUM*0.5d0**(KAIMT-K+1)) GO TO 20270
      GO TO 20272
      END IF
            TEND=END(PART)
            KMAX=KMAXF
...
C           1 .LE.  I  .LE. 7
      IF(I.GE.3)THEN
      IF (I.EQ.3.AND.ERRI.GE.EPSMIN.AND.REP.GT.0.3d0) GO TO 20278
      IF (ERR.EQ.0.0d0) GO TO 20278
      IF (ERR.GT.EPSMIN) GO TO 20278
      IF (ERRI.GT.10.0d0*EPSMIN) GO TO 20278
...
20290 CONTINUE
                  ALPHA=ALPHA*GAMMA(KK-1)
      IF (ALPHA.GT.2.0d0) GO TO 20291
                  DELTA=DELTA*BETA
      GO TO 20290
20291 CONTINUE
      END IF
20286 IF(SEARCH.NE.1)THEN
               DISCHK=MAX(DISCHK,0)
               IF (IPRINT.GT.3) CALL DINTO (12,WORK)
      IF (SEARCH.EQ.6) GO TO 20283
               KMAX=MIN(MAXK-1,KMAX)
               IF (DELTA.LE.Z(2)*ABSDIF                                 
     *         .OR.(K.LT.6.AND.DELTA.LT.Z(3)*ABSDIF)) GO TO 2610
               IF (DELTA.GT.Z(4)*ABSDIF) KMAX=MIN(KMAX,5)
               KAIMT=MIN(KMAX,KAIMT)
      IF (K.GE.KMAX) GO TO 20283
               DELTA=ABSDIF+ABSDIF
               ERR=ERRC+EXTRA
               IF (K.GE.4) DISCHK=-1
      ...
      IF(MIN(ABS(TB),TP+DELTA).GE.ABS(WORRY(PART)-START(PART)))THEN
                  DISCHK=-1
                  KMAX=KMAXF
      IF (TP+1.25d0*DELTA.GE.ABS(TB)) GO TO 20284
      END IF
      END IF
      IF(TP.LT.ABS(TEND-START(PART))-DELMIN)THEN
      IF (K.GE.KAIMT) GO TO 20298
      IF (.NOT.HAVDIF) GO TO 20298
      IF (PHISUM.LE.10.0d0*PHTSUM) GO TO 20298
      IF (NSUB.GE.NSUBMX) GO TO 20298
      ...
      END IF
               TEND=ALOCAL+SIGN(DELTA,TB)
               KMAX=KMAXF
20298       IF (DID1.OR.PART.EQ.1.OR.FAIL) GO TO 2610
...
2690  WHERE=1
     ...
     * IF (KONVRG+KONVRG-LENDT) 2700,2700,1190
      KK=4
      J=6
      GO TO 2710
2700  KK=3
...
2820  FAT(WHERE2)=FNCVAL
      ...
      ELSEIF(LOCAL(WHERE2).EQ.BINIT)THEN
