      SUBROUTINE SERMN (SUBNAM,INDIC,LEVEL,MSG,NVAL,
     1                  LABELS,VALUES,FLAG)
C     .  Copyright (C) 1989, California Institute of Technology.
C     .  U. S. Government sponsorship under
C     .  NASA contract NAS7-918 is acknowledged.
C>> 1994-10-20 SERMN  Krogh  Changes to use M77CON
C>> 1987-10-02 SERMN  Lawson  Initial code.
c--S replaces "?": ?ERMN, ?ERVN
C
C     ------------------------------------------------------------------
C
C     This subr calls ERMSG to initiate an error message and then calls
C     SERVN to print an array of values with labels.
C
C     ------------------------------------------------------------------
...
C
      ...
      CALL SERVN (NVAL,LABELS,VALUES,FLAG)
C
      RETURN
C
      END
