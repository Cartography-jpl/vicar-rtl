...
c     ------------------------------------------------------------------
      ...
      real             A1, ABSA1, ALPHA, AMAX                           00027500
      ...
      parameter(ZERO = 0.0E0, TWO = 2.0E0, FACTOR = 0.01E0)             00028500
...
*              call SROT (1, B(IS),1, B(IS+1),1, CC,SS)                 00129400
*              if(KPRINT .ge. 3)
...
30020    if(KPRINT .ge. 2) print '(1x,a,2i4)',                          
     *   'Gauss elim in pairs of rows.  IGAUS1, IGAUS2 =',IGAUS1,IGAUS2
      ...
      END IF
               ...
               call SAXPY(N, FAC, A(IS,1),LDA, A(IS+1,1),LDA)           00136500
               A(IS+1,JS) = ZERO
...
c
30008 BSAVE = B(NSP1)
      B(NSP1) = B(NSP1) - SDOT(N, A(NSP1,1), LDA, X, 1)                 00140800
      DO 20284 IS = 1,NSETS
         JS = INDEX(IS)
      IF(IS .gt. 1)THEN
