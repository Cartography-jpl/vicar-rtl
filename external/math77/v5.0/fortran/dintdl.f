...
C
c--D replaces "?": ?INT, ?INTA, ?intc, ?intec, ?INTDL, ?INTO
C
C     *****     FORMAL ARGUMENT   **************************************
C
...
C      DATA BETAS / .3436491673103708451d001, .2909944487358056275d000,
C     *  .1000000000000000001d001, .1549193338482966760d001,
C     * -.1878361089654305178d000, .2909944487358056232d000,
C     *  .1878361089654305149d000, .1878361089654305149d000,
C     *  .1000000000000000015d001, .1830891918707665993d001,
C     *  .5461818853326139665d000, .1275863152521727801d001,
C     *  .1877974359956861711d001,-.2908356455650225802d000,
C     *  .1000000000000000003d001, .1121212539609889453d001,
C     *  .1411118538882285126d001, .2061029159147656548d000,
C     *  .7837831181373271228d000, .6990495472071992051d000,
C     *  .6990495472071992051d000, .7764649827988754109d000,
C     * -.2654374897523893370d000, .5461818853326139587d000,
C     *  .3710664836162815639d000, .2948330583120690783d000,
C     *  .2654374897523893283d000, .2654374897523893275d000,
C     *  .1000000000000000036d001, .2160483964289764787d001,
C     *  .4628592558560086054d000, .1580721165376834188d001,
C     *  .2788648704047761366d001,-.1659797647456139336d000,
C     *  .1348061361080862260d001, .1938801234758797259d001,
C     *  .3001371201600030120d001, .5530131183278168619d-001,
C     *  .1217373546890437278d001, .1549754626219785878d001,
C     *  .2074091833232865716d001, .2928362520543975785d001,
C     * -.1888472190338949389d-001,.1128427531866524394d001,
C     *  .1318613567768740554d001, .1600194155392385446d001,
C     *  .2022328205978644955d001, .2663864875210043425d001,
C     *  .7089219156396005268d-002,.1059422356252840359d001,
C     *  .1156722975732715836d001, .1303394479759645425d001,
C     *  .1518037435357655518d001, .1829746290708357198d001,
C     *  .2281090415029519236d001,-.3107820325615749339d-002,
C     *  .1000000000000000007d001, .1028853894914960778d001,
C     *  .1089361496056109992d001, .1187656139924609753d001,
C     *  .1334063529367354927d001, .1544285866555422247d001,
C     *  .1839592669101145570d001, .1689406778911703374d-002,
C     *  .9439106076041133657d000, .9174389213758399244d000,
C     *  .9174389213758399244d000, .9435097871391599084d000,
C     *  .9977420273821314863d000, .1084782404725432559d001,
C     *  .1211987194763725285d001, .1388740619829111076d001,
C     * -.1216502747013758565d-002,.8861889414785074481d000,
C     *  .8116449626771402972d000, .7665628757411781400d000,
C     *  .7453813701489683382d000, .7453813701489683365d000,
C     *  .7659548081345759537d000, .8082259176409903757d000,
C     *  .8747663621098320137d000, .9688039688731088254d000,
C     *  .1255674817712366966d-002,.8214405533571194637d000,
C     *  .7029626866105575496d000, .6238580132970762736d000,
C     *  .5722253065058340695d000, .5411220158316336791d000,
C     *  .5265875548985245415d000, .5265875548985245415d000,
C     *  .5404122752915469377d000, .5682467824057592445d000,
C     *  .6105250012592685202d000,-.2056713181478912089d-002,
C     *  .7418059955358485150d000, .5827083724168839593d000,
C     *  .4801712113071248704d000, .4122773863015805726d000,
C     *  .3670318230087162626d000, .3375820566477249038d000,
C     *  .3199261416708740619d000, .3117418541236820569d000,
C     *  .3117418541236820569d000, .3192575114045456230d000,
C     *  .3337942651525015294d000, .6161619285278180942d-002,
C     *  .6326226420594590703d000, .4398667200206020996d000,
C     *  .3286669728647044621d000, .2600621241862664580d000,
C     *  .2157588962131737290d000, .1863878189966076094d000,
C     *  .1668253817995868195d000, .1541355533671636686d000,
C     *  .1465855112207078905d000, .1431347342606662998d000,
C     *  .1431347342606662993d000, .1460769330400709832d000,
C     * -.4218064520555042749d-001,.4628592558560086436d000,
C     *  .2623677271576596603d000, .1694821597218475388d000,
C     *  .1200403163514239665d000, .9113109297367898293d-001,
C     *  .7309959229942654766d-001,.6136503430084129995d-001,
C     *  .5355473492811662567d-001,.4835640867710043200d-001,
C     *  .4500777786787335424d-001,.4304768732135345497d-001,
C     *  .4218064520555042532d-001,.4218064520555042532d-001,
C     *  .1000000000000000051d001 /
c++ END
C
C     *****    PROCEDURES     ******************************************
C
...
C     IF JUMP CAN BE IGNORED.
     ...
     *          XJP=-XJP
      ...
      IF (ABS(XJP).LT.1.0D-3) GO TO 20036
...
20036 IF(J2.ne.0)THEN
     ...
     *         .GE.(PHIT(J2+1)/PMAX)*PHIT(J2+1)) XJ=-XJ
      ...
      IF (ABS(XJ).LT.1.0D-3) GO TO 20041
