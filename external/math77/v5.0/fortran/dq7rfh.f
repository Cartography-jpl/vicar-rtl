* File: DQ7RFH.for      Four subrs used by the
*       David Gay & Linda Kaufman nonlinear LS package.
*             DQ7RFH, DV7PRM, DS7CPR, DV7SWP
*       Needed by versions that handle the Separable problem.
*       The first 3 are called by DRNSG & DRNSGB.
*       DV7SWP is called by DQ7RFH.
*
