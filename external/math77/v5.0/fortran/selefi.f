...
C SERM1   Displays an error message.                                    00003100
...
C
      ...
      REAL             RK, RM, RN, S0, S1, S2, S3, S4, SGN, SI, SJ, SK  00004100
...
C     PI2 = PI/2
C
      DATA LN2 /0.693147180559945309417232121458176568075E0/            00005100
...
C
      ...
      IF(ABS(K) .GT. 1.0e0)THEN
         CALL SERM1 ('SELEFI',1,0,'ABS(K) .GT. 1.0','K',K,'.')          00007200
         IERR = 2
         RETURN
      END IF
      IERR = 0
