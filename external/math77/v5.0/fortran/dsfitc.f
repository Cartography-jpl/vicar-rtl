...
c     ------------------------------------------------------------------
      ...
      logical   USEWT1
      parameter( ONE = 1.0D0, UNBND = 99.0D0, ZERO = 0.0D0)             00028300
...
20021 IF (.NOT.( SD(1) .gt. ZERO)) GO TO 20022
      ...
      GO TO 20020
20022    IERR5 = 1100
         call ERMSG('DSFITC',IERR5,0,'Require SD(1) .ne. Zero','.')     00034400
...
30002 call DSBASI(KORDER, NCOEF, TKNOTS, XI(IC), XI(IC+1),              
     *            J1, J2,  WORK(IWXS))
...
c
30004       call DSFIND(TKNOTS, KORDER, NCOEF+1, X, LEFT, MODE)
