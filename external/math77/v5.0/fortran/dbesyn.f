...
c--D replaces "?": ?BESYN, ?BESPQ, ?ERV1, ?GAMMA, ?LGAMA                00001200
C
...
c     ----------
      ...
      double precision LOGPI, LOGTWO, ONE, P, PI, PIV2, PSI1, PSIZ      00006200
...
c
      ...
      parameter( C16 = 16.D0, FOUR = 4.0D0)                             00007200
...
c          LOGTWO = Ln(2)                                               00008200
      ...
      DATA EPS / ZERO /
C
      DATA D2SER( 0) / +.36746 69051 96615 96151 85D+00/                00009200
      ...
      DATA D2SER(10) / +.34527 80604 49258 45750 60D+01/                00010200
C
c     ------------------------------------------------------------------
C
...
c     >                                           Error 6.
      DO 20009 I = 1, NUM
            BY(I) = -BIG
20009 CONTINUE
         CALL ERMSG('DBESYN',6,0,                                       00014600
