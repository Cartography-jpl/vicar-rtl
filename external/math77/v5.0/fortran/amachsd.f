...
c++ Code for (HOW=RUN) | SYS=IEEE is INACTIVE 
C      integer IE1, IE2, IE3, IE4, IE5, IE6, IE7, IE8, IE10, IE11,
C     1   IE12, IE13, IE14, IE15, IE16, IE17
c++ end
...
c
c++ Code for (HOW=RUN) | SYS=IEEE is INACTIVE 
Cc     Parameters for IEEE when generating at run time:
C      PARAMETER (IE1 =5, IE2 =6, IE3 =7, IE4 =6)
C      PARAMETER (IE5 =32, IE6 =4, IE7 =2, IE8 =31)
C      PARAMETER (IE10 =2, IE11 =24, IE12 =-125, IE13 =128)
C      PARAMETER (IE14 =53, IE15 =-1021, IE16 =1024, IE17=0)
c++ Code for SYS = IEEE is INACTIVE 
C      PARAMETER (IM1 = IE1, IM2 = IE2, IM3 = IE3, IM4 = IE4)
C      PARAMETER (IM5 = IE5, IM6 = IE6, IM7 = IE7, IM8 = IE8)
C      PARAMETER (IM10 = IE10, IM11 = IE11, IM12 = IE12, IM13 = IE13)
C      PARAMETER (IM14 = IE14, IM15 = IE15, IM16 = IE16, IM17 = IE17)
CC     -----------------------------------------------------------------
...
CC     -----------------------------------------------------------------
c++ Code for SYS = CRAY_YMP_SD is ACTIVE
