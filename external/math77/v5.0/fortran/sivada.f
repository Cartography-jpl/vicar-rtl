c$$   START( SIVADA, ROOT = 'SIVA', $ROOT$G)
c     .  Copyright (C) 1989, California Institute of Technology.
c     .  All rights reserved.  U. S. Government sponsorship under
c     .  NASA contract NAS7-918 is acknowledged.
c>> 1994-03-07 SIVADA  Krogh  Allow larger order in single precision.
c>> 1993-04-16 SIVADA  Krogh  Additions for Conversion to C.
c>> 1992-04-08 SIVADA  Krogh  Passed IDAT to MESS instead of IFLAG.
c>> 1992-04-08 SIVADA  Krogh  Unused labels 120 and 220 removed.
c>> 1992-03-10 SIVADA  Krogh  Fixed value for KDIM in single p. version.
c>> 1991-04-01 SIVADA  Krogh  Removed extra "." in character const.
c>> 1990-12-20 SIVADA  Krogh  Removed obsolete code.
c>> 1990-10-22 SIVADA  Krogh  Fixed TSPECS(1) not getting set on conv.
c>> 1990-09-28 SIVADA  Krogh  First "Library" version.
c>> 1989-07-06 SIVADA  Krogh  Initial code.  More needs adding.
c
...
c
c
      subroutine SIVADA(TSPECS, Y, F, KORD, IFLAG, LEQ)
c
...
c
      ...
      real             HH, HDIS, SUMHI, SUMLO, SUMLOM, TP, TP1,
     1   TP2, C0, C1, CP1, CP5
      real             CDA(KDIM-1)
      parameter (C0 = 0.E0)
      parameter (C1 = 1.E0)
...
cAC Option 21 must be used initially.$E
      ...
      data MTXTAA/'SIVADA$BIFLAG=$I, is not allowed on entry.$EOption 21
