      SUBROUTINE DBSOL (MODE,G,LDG,NB,IR,JTPREV,X,N,RNORM, IERR3)
C>> 1994-11-11 DBSOL  Krogh  Declared all vars.
C>> 1994-10-20 DBSOL  Krogh  Changes to use M77CON
C>> 1987-11-24 DBSOL  Lawson Initial code.
c--D replaces "?": ?BSOL
...
c     ------------------------------------------------------------------
      ...
      double precision G(LDG,NB+1),X(N), ZERO, RNORM, RSQ, S
...
C     -- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  130 continue
      IERR3 = I
      call IERM1('DBSOL', IERR3, 0,'Singular matrix',
     * 'MODE', MODE, ',')
