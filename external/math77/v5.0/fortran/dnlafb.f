      SUBROUTINE  DNLAFB(N, P, X, B, DCALCR, IV, LIV, LV, V)
c>> 1994-10-20 DNLAFB Krogh  Changes to use M77CON
c>> 1990-06-29 DNLAFB CLL @ JPL
...
C        THE PARAMETERS FOR  DNLAFB ARE THE SAME AS THOSE FOR  DNLAGB
C     (WHICH SEE), EXCEPT THAT DCALCJ IS OMITTED.  INSTEAD OF CALLING
C     DCALCJ TO OBTAIN THE JACOBIAN MATRIX OF R AT X,  DNLAFB COMPUTES
C     AN APPROXIMATION TO IT BY FINITE (FORWARD) DIFFERENCES -- SEE
C     V(DLTFDJ) BELOW.   DNLAFB DOES NOT COMPUTE A COVARIANCE MATRIX.
...
c--D replaces "?": ?NLAFB, ?IVSET, ?RN2GB, ?V7SCP, ?CALCR
C
