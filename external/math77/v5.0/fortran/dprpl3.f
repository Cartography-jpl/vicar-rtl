c  File DPRPL3.for contains subroutines DPRPL3, DPRPL4, DPRPL5.
...
c     ==================================================================
      SUBROUTINE DPRPL4(A, B, C, D, KMAJOR, KMINOR, FMT, KSIZE)
...
c     Examples: 'ss,f05.01     ' or 'ss,1pe15.07d02'
...
c     ------------------------------------------------------------------
      ...
      character FMT*14
      data(SPAN(I),I=1,6 )/12.0d0,14.0d0,15.0d0,16.0d0,18.0d0,20.0d0/
C     data(KMAJ(I),I=1,6 )/ 6.0d0, 7.0d0, 3.0d0, 8.0d0, 9.0d0,10.0d0/
      data(EKMN(I),I=1,6 )/ 2.0d0, 2.0d0, 5.0d0, 2.0d0, 2.0d0, 2.0d0/

      data(SPAN(I),I=7,10)/ 20.0d0,25.0d0, 30.0d0,35.0d0/
c     data(KMAJ(I),I=7,10)/  4.0d0, 5.0d0,  3.0d0, 7.0d0/
      data(EKMN(I),I=7,10)/  5.0d0, 5.0d0, 10.0d0, 5.0d0/

      data(SPAN(I),I=11,16)/40.0d0,45.0d0, 50.0d0,60.0d0,70.0d0,80.0d0/
C     data(KMAJ(I),I=11,16)/ 4.0d0, 9.0d0,  5.0d0, 6.0d0, 7.0d0, 8.0d0/
      data(EKMN(I),I=11,16)/10.0d0, 5.0d0, 10.0d0,10.0d0,10.0d0,10.0d0/

      data(SPAN(I),I=17,18)/ 90.0d0,100.0d0/
C     data(KMAJ(I),I=17,18)/  9.0d0, 10.0d0/
      data(EKMN(I),I=17,18)/ 10.0d0, 10.0d0/
...
c
      write(6,'(a,4e20.8)') ' DPRPL4 ERROR.. A,B,C,D,=',A,B,C,D
  110 continue
      if( abs(C) .lt. 0.0001d0 * BMA) then
         C = 0.0d0
      elseif( abs(D) .lt. 0.0001d0 * BMA) then
         D = 0.0d0
      endif
c
...
c
      KMAJOR=int(0.5d0 + SPAN(I)/EKMN(I))
      KMINOR=EKMN(I)
c
...
c     ==================================================================
      SUBROUTINE DPRPL5(C, D, KMAJX, FMT, KSIZE, LEFT, NIMAGE, IMAGE)
C     .  Copyright (C) 1992, California Institute of Technology.
C     .  U. S. Government sponsorship under
C     .  NASA contract NAS7-918 is acknowledged.
