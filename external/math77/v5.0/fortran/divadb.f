      subroutine DIVADB(LPRINT, TSPECS, Y, F, KORD, NTEXT)
...
c ********
      MACTFV(3) = max(IOP5, 4)
c--D Next line special: P=>D, X=>Q
      call DMESS(MACTFV, '$NTSPECS:$B', KORD, TSPECS)
      MACTFV(3) = NY
c--D Next line special: P=>D, X=>Q
      call DMESS(MACTFV, 'Y:$B', KORD, Y)
c--D Next line special: P=>D, X=>Q
      call DMESS(MACTFV, 'YN:$B', KORD, Y(NYNY))
      MACTFV(3) = NTE
c--D Next line special: P=>S, X=>D
      call DMESS(MACTFV, 'F:$B', KORD, F)
      MACT2(6) = NTE
