...
C
      ...
      PARAMETER(ZERO=0.E0, ONE=1.E0, C75=.75E0, HALF=.5E0,              00005200
     *          C43=-.4375E0, C95=.95E0)
...
c++  Code for {S} is active
        Z(J) = ZERO
c++  Code for {D} is inactive
C        Z(2*J-1) = ZERO
C        Z(2*J) = ZERO
c++  End                                                                00011500
        N = N - 1
...
C
      GO TO 70
C     ********** ONE ROOT FOUND **********
c++  Code for {S} is active                                             00034400
...
c++  Code for {D} is inactive                                           00036400
C      Z(2*NA-1) = X + ZZ
C      Z(2*NA) = ZERO
C      Z(2*EN-1) = Z(2*NA-1)
C      Z(2*EN) = Z(2*NA)
