      subroutine ISSTA1(ITAB, NI, ISTATS, XSTATS, IHIST, ILOW, NCELLS)
C     .  Copyright (C) 1989, California Institute of Technology.
C     .  U. S. Government sponsorship under
C     .  NASA contract NAS7-918 is acknowledged.
c>> 1994-10-20 ISSTA1 Krogh  Changes to use M77CON
c>> 1994-06-22 ISSTA1 CLL  Changed name to I[D/S]STA1.
C>> 1989-10-20 CLL
...
c     ------------------------------------------------------------------
      ...
      integer J, NM1
      real             DELTA, ONE, PREV, XSTATS(2)
      real             SUMSQ, TERM, X, ZERO
